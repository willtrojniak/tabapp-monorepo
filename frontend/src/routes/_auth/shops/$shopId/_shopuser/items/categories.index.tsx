...
export const Route = createFileRoute('/_auth/shops/$shopId/_shopuser/items/categories/')({
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} autoComplete='off' className='flex flex-grow'>
        <Card className='w-full'>
          ...
          <CardContent>
            <CategoryTabSelect categories={categories} value={categoryId?.toString() ?? selectedCategory?.id.toString() ?? ""} onValueChange={onCategoryChange} disabled={editing} allowNone={false} />
          </CardContent>
          <CardContent>
